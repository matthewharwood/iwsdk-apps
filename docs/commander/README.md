...
`--all-reviewed` compiles all 1,192 currently source-bound primary definitions, 20 auxiliary token templates and 51 legal development decks, including 97 temporary creature modifiers, 232 exact keyword-reminder bodies, seven counterspells, five creature-return spells and 27 fixed token producers, 41 static-bonus permanents and 20 mandatory entry observers and two conditional self-entry creatures (Scholar of Stars and Donatello, Turtle Techie). Tatyova closes the Merfolk Mistbinder commander gap; Inspiring Veteran and Kargan Warleader remain unexecuted. Source admission verifies every definition against the closed authenticated registry. Earlier constructor flags remain available for their narrower development subsets.
