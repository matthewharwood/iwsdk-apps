...
`--all-reviewed` compiles all 1,198 currently source-bound primary definitions, 20 auxiliary token templates and 55 legal development decks, including 97 temporary creature modifiers, 232 exact keyword-reminder bodies, seven counterspells, five creature-return spells, 27 fixed token producers, 41 static-bonus permanents, 20 mandatory entry observers, two conditional self-entry creatures (Scholar of Stars and Donatello, Turtle Techie), Strict Proctor's entry-caused trigger tax, and five damage replacement/prevention permanents. Tatyova closes the Merfolk Mistbinder commander gap; Inspiring Veteran and Kargan Warleader remain unexecuted. Source admission verifies every definition against the closed authenticated registry. Earlier constructor flags remain available for their narrower development subsets.
